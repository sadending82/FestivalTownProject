...
public struct PlayerMove : IFlatbufferObject
{
  ...
  public static Offset<PacketTable.PlayerTable.PlayerMove> CreatePlayerMove(FlatBufferBuilder builder,
      int id = 0,
    ...
    PlayerMove.AddState(builder, state);
  ...
  public static void StartPlayerMove(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<PacketTable.PlayerTable.PlayerMove> EndPlayerMove(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.PlayerTable.PlayerMove>(o);
  }
}
