...
void PacketManager::Init(Server* server)
{
    ...
    PacketProcessorMap[PACKETTYPE::C2S_PLAYERMOVE] = std::make_unique<PacketPlayerMove>();
    PacketProcessorMap[PACKETTYPE::C2S_PLAYERSTOP] = std::make_unique<PacketPlayerStop>();
}
