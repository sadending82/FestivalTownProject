...
std::vector<uint8_t> PacketMaker::MakePurchaseGoodsResponsePacket(int result, int goods_index, int currency_index, int currency_amount)
{
	flatbuffers::FlatBufferBuilder Builder;

	Builder.Finish(PacketTable::ShopTable::CreatePurchaseGoodsResponse(Builder, result, goods_index, currency_index, currency_amount));
...
std::vector<uint8_t> PacketMaker::MakePlayerCalculatedDamagePacket(int targetID, int attackType, int hp, int damageAmount, int stamina, Vector3f knockback_direction)
{
	flatbuffers::FlatBufferBuilder Builder;
	...
	Builder.Finish(PacketTable::PlayerTable::CreatePlayerCalculatedDamage(Builder, targetID, attackType, hp, damageAmount, stamina, dir));
