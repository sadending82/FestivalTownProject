...
public struct Vec3f : IFlatbufferObject
{
  ...
  public static Offset<PacketTable.ObjectTable.Vec3f> CreateVec3f(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<PacketTable.ObjectTable.Vec3f> EndVec3f(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.ObjectTable.Vec3f>(o);
  }
}
