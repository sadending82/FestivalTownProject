...
public struct Vec3 : IFlatbufferObject
{
  ...
  public static Offset<PacketTable.Player.Vec3> CreateVec3(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<PacketTable.Player.Vec3> EndVec3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.Player.Vec3>(o);
  }
}
