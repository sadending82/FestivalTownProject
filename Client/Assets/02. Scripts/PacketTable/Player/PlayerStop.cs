...
public struct PlayerStop : IFlatbufferObject
{
  ...
  public static Offset<PacketTable.Player.PlayerStop> CreatePlayerStop(FlatBufferBuilder builder,
      int key = 0,
  ...
  public static Offset<PacketTable.Player.PlayerStop> EndPlayerStop(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.Player.PlayerStop>(o);
  }
}
