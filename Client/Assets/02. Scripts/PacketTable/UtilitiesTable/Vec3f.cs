...
public struct Vec3f : IFlatbufferObject
{
  ...
  public static Vec3f GetRootAsVec3f(ByteBuffer _bb) { return GetRootAsVec3f(_bb, new Vec3f()); }
  public static Vec3f GetRootAsVec3f(ByteBuffer _bb, Vec3f obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<PacketTable.UtilitiesTable.Vec3f> CreateVec3f(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
    builder.StartTable(3);
    Vec3f.AddZ(builder, z);
    Vec3f.AddY(builder, y);
    Vec3f.AddX(builder, x);
    return Vec3f.EndVec3f(builder);
  }

  public static void StartVec3f(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<PacketTable.UtilitiesTable.Vec3f> EndVec3f(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.UtilitiesTable.Vec3f>(o);
  }
}


static public class Vec3fVerify
{
