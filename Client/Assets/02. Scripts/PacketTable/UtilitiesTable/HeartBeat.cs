...
public struct HeartBeat : IFlatbufferObject
{
  ...
  public static Offset<PacketTable.UtilitiesTable.HeartBeat> CreateHeartBeat(FlatBufferBuilder builder,
      long time = 0) {
  ...
  public static Offset<PacketTable.UtilitiesTable.HeartBeat> EndHeartBeat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PacketTable.UtilitiesTable.HeartBeat>(o);
  }
}
