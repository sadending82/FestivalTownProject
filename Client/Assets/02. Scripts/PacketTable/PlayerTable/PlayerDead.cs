...
public struct PlayerDead : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static PlayerDead GetRootAsPlayerDead(ByteBuffer _bb) { return GetRootAsPlayerDead(_bb, new PlayerDead()); }
  public static PlayerDead GetRootAsPlayerDead(ByteBuffer _bb, PlayerDead obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PlayerDead __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
...
static public class PlayerDeadVerify
{
