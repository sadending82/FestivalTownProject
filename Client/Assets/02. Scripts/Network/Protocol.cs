...
namespace NetworkProtocol
{
    ...
    public enum ePacketType
    {
        ...
        S2C_BATCH_RECEIVE_PASS_REWARDS_RESPONSE,

        S2C_PURCHASE_GOODS_RESPONSE,
        ...
        C2S_BATCH_RECEIVE_PASS_REWARDS_REQUEST,

        C2S_PURCHASE_GOODS_REQUEST,
